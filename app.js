(() => {
  ...
  const STAGES = [
    ...
    { id: "meeting", title: "Встреча / ОСС", wait: "После встречи ЭД — публикация ОСС" },
...
Контакт: _______________`,
      ...
      meeting: {
        to: "Чат жителей — напоминание о встрече / ОСС",
        body:
`Соседи!

По адресу ${address} объявлена встреча с представителями «Электронного дома»
и/или готовится ОСС по установке шлагбаума.

Важно:
— на предварительной встрече обычно нет юридически значимого голосования;
— на ОСС голосуют собственники (онлайн и, при смешанном формате, на бумаге со СНИЛС);
— схема размещения АМПП должна быть в материалах собрания.

Проверьте доступ в ed.mos.ru / mos.ru и подготовьте СНИЛС.
Следите за объявлениями у подъездов и уведомлениями mos.ru.`,
      },
      install: {
